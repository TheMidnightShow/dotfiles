...
theme.set_highlights = function()
  ...
  -- Telescope
  hl(0, "TelescopeSelection", { fg = 'NONE', bg = c._c2 })
  ...
  hl(0, "TelescopePreviewTitle", { fg = c._c6, bg = 'NONE' })
  hl(0, "TelescopePromptCounter", { fg = c.err, bg = 'NONE' })
  hl(0, "TelescopePreviewHyphen", { fg = c.err, bg = 'NONE' })
